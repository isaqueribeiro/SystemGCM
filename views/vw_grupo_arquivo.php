...
<?php
    ...
    $qtde = 10;
    $file = "../logs/cookies/grupoarquivo_" . sha1($user->getCodigo()) . ".json";
    if (file_exists($file)) {
...
<html>
  <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content-header">
          <h1>
            Grupos de Arquivos
            <small>Relação de grupos de arquivos</small>
          ...
          <ol class="breadcrumb">
              ...
              <li class="active" id="page-click" onclick="preventDefault()">Grupos de Arquivos</li>
          </ol>
        </section>
            ...
            <div class="box-body form-horizontal">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <select class="form-control select2"  id="qtde-registros-grupo" style="width: 70px;">
          ...
          <div class="box box-info" id="box-pesquisa">
              <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                      ...
                      <button type="button" class="btn btn-primary" title="Atualizar" onclick="pesquisar_gruposarquivos()" id="btn-atualizar-pesquisa"><i class="fa fa-refresh"></i></button>
              ...
              <div class="box-body form-horizontal" id="box-formulario">
                <div class="col-md-10">
                    <div class="form-group" style="margin: 2px;">
                        <label for="cd_grupo" class="col-sm-2 control-label padding-label">Código</label>
                        <div class="col-sm-1 padding-field">
                            <input type="text" class="form-control proximo_campo" id="cd_grupo" maxlength="5" placeholder="00" readonly>
                        </div>
                    </div>
                    <input type="hidden" id="cd_grupo" value="0">
                    <div class="form-group" style="margin: 2px;">
                        <label for="ds_grupo" class="col-sm-2 control-label padding-label">Descrição</label>
                        <div class="col-sm-10 padding-field">
                            <input type="text" class="form-control proximo_campo" id="ds_grupo" maxlength="50" placeholder="Descrição">
                        </div>
                    </div>
                    <div class="form-group" style="margin: 2px;">
        ...
        <script type="text/javascript">
            ...
            function configurar_tabela(id) {
                if (typeof($(id)) !== "undefined") {
                    var qt_registros = parseInt('0' + $('#qtde-registros-grupo').val());
                    $(id).DataTable({
                        "paging": true,
                        ...
                        "columnDefs": [
                            ...
                            {"orderable": false, "targets": 3}  // <Excluir>
                        ],
            ...
            function abrir_cadastro(handler, id) {
                ...
                var registro = id.replace("grupoarquivo", "");
                
                carregar_registro_grupoarquivo(registro, function(data){
                    $('#operacao').val("editar");
                    
                    $('#cd_grupo').val(zero_esquerda(data.registro[0].codigo, 3));
                    $('#ds_grupo').val(data.registro[0].descricao);
            ...
            function salvar_cadastro() {
                var registro  = $('#cd_grupo').val();
                var requedido = "";

                if ($('#ds_grupo').val() === "") requedido += "<li>Descrição</li>";

                if (requedido !== "") {
                    show_campos_requeridos("Alerta", "Cadastro de grupos de arquivos", requedido);
                } else {    
                    salvar_registro_grupoarquivo(registro, function(){
                        var linha = "#tr-linha_" + parseFloat($('#cd_grupo').val());
                        $('#id_linha').val(linha);

                        // Atualizar status do registro na tabela
                        var referencia = parseInt("0" + $('#cd_grupo').val());
                        set_status_fa('#status_grupoarquivo_' + referencia, $('#sn_ativo').is(":checked"));
            ...
            function excluir_registro(id, elemento) {
                ...
                var acesso  = "0100";
                get_allow_user(usuario, rotina, acesso, function(){
                    var registro  = id.replace("excluir_grupoarquivo_", "");
                    ...
                    excluir_grupoarquivo(registro, descricao, function(){
