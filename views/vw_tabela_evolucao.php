...
<?php
    ...
    $qtde = 10;
    $file = "../logs/cookies/tabela_evolucao_" . sha1($user->getCodigo()) . ".json";
    if (file_exists($file)) {
...
<html>
  <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content-header">
          <h1>
            Tabela de Evoluções
            <small>Relação de evoluções de medidas aplicadas aos pacientes</small>
          ...
          <ol class="breadcrumb">
              ...
              <li class="active" id="page-click" onclick="preventDefault()">Tabela de Evoluções</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box" id="box-filtro">
            ...
            <div class="box-footer">
                    ...
                    <select class="form-control select2"  id="qtde-registros-evolucao" style="width: 70px;">
          ...
          <div class="box box-info" id="box-pesquisa">
              <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                      ...
                      <button type="button" class="btn btn-primary" title="Atualizar" onclick="pesquisar_tabela_evolucoes()" id="btn-atualizar-pesquisa"><i class="fa fa-refresh"></i></button>
          ...
          <div class="box box-primary" id="box-cadastro">
              <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                      ...
                      <input type="hidden" id="id_evolucao">
              ...
              <div class="box-body form-horizontal" id="box-formulario">
                <div class="col-md-10">
                    <div class="form-group" style="margin: 2px;">
                        <label for="cd_evolucao" class="col-sm-2 control-label padding-label">Código</label>
                        <div class="col-sm-1  padding-field">
                            <input type="text" class="form-control proximo_campo" id="cd_evolucao" maxlength="10" placeholder="000" readonly>
                        </div>
                    </div>
                    <div class="form-group" style="margin: 2px;">
                        <label for="ds_evolucao" class="col-sm-2 control-label padding-label">Descrição</label>
                        <div class="col-sm-10 padding-field">
                            <input type="text" class="form-control proximo_campo" id="ds_evolucao" maxlength="250" placeholder="Descrição da evolução de medida...">
                        </div>
                    </div>
                    <div class="form-group" style="margin: 2px;">
                        <label for="un_evolucao" class="col-sm-2 control-label padding-label">Unidade</label>
                        <div class="col-sm-1 padding-field">
                            <input type="text" class="form-control proximo_campo" id="un_evolucao" maxlength="25" placeholder="Unidade de medida">
                        </div>
                    </div>
                    <div class="form-group" style="margin: 2px;">
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $('#qtde-registros-evolucao').val(<?php echo $qtde;?>);
                $('#qtde-registros-evolucao').select2();
            ...
            function configurar_tabela(id) {
                if (typeof($(id)) !== "undefined") {
                    var qt_registros = parseInt('0' + $('#qtde-registros-evolucao').val());
                    $(id).DataTable({
                        "paging": true,
...
//                        ],
            ...
            function abrir_cadastro(handler, id) {
                ...
                carregar_registro_tabela_evolucao(registro, function(data){
                    $('#operacao').val("editar");
                    
                    $('#id_evolucao').val(data.registro[0].id);
                    $('#cd_evolucao').val(zero_esquerda(data.registro[0].codigo, 2));
                    $('#ds_evolucao').val(data.registro[0].descricao);
                    $('#un_evolucao').val(data.registro[0].unidade);
            ...
            function fechar_filtro(pesquisar) {
                ...
                $('#box-filtro').hide();
                if (pesquisar === true) pesquisar_tabela_evolucoes();
            } 
            ...
            function salvar_cadastro() {
                var registro  = $('#id_evolucao').val();
                var requedido = "";

                if ($('#ds_evolucao').val() === "") requedido += "<li>Descrião</li>";
                if ($('#un_evolucao').val() === "") requedido += "<li>Unidade de Medida</li>";

                if (requedido !== "") {
                    show_campos_requeridos("Alerta", "Cadastro de evoluções", requedido);
                } else {    
                    salvar_registro_tabela_evolucao(registro, function(data){
                        ...
                        set_status_fa('#status_evolucao_' + referencia, $('#sn_ativo').is(":checked"));
            ...
            function excluir_registro(id, elemento) {
                ...
                var acesso  = "0100";
                get_allow_user(usuario, rotina, acesso, function(){
                    var registro  = id.replace("excluir_evolucao_", "");
                    ...
                    excluir_tabela_evolucao(registro, descricao, function(){
