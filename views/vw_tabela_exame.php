...
<?php
    ...
    $qtde = 10;
    $file = "../logs/cookies/tabela_exame_" . sha1($user->getCodigo()) . ".json";
    if (file_exists($file)) {
...
<html>
  <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content-header">
          <h1>
            Tabela de Exames
            <small>Relação de exames solicitados aos pacientes</small>
          ...
          <ol class="breadcrumb">
              ...
              <li class="active" id="page-click" onclick="preventDefault()">Tabela de Exames</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box" id="box-filtro">
            ...
            <div class="box-footer">
                    ...
                    <select class="form-control select2"  id="qtde-registros-exame" style="width: 70px;">
          ...
          <div class="box box-info" id="box-pesquisa">
              <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                      ...
                      <button type="button" class="btn btn-primary" title="Atualizar" onclick="pesquisar_tabela_exames()" id="btn-atualizar-pesquisa"><i class="fa fa-refresh"></i></button>
              ...
              <div class="box-body form-horizontal" id="box-formulario">
                <div class="col-md-10">
                    <div class="form-group" style="margin: 2px;">
                        <label for="cd_exame" class="col-sm-2 control-label padding-label">Código</label>
                        <div class="col-sm-1  padding-field">
                            <input type="text" class="form-control proximo_campo" id="cd_exame" maxlength="10" placeholder="000" readonly>
                        </div>
                    </div>
                    <div class="form-group" style="margin: 2px;">
                        <label for="nm_exame" class="col-sm-2 control-label padding-label">Nome</label>
                        <div class="col-sm-10 padding-field">
                            <input type="text" class="form-control proximo_campo" id="nm_exame" maxlength="250" placeholder="Nome do exame...">
                        </div>
                    </div>
                    <div class="form-group" style="margin: 2px;">
                        <label for="sg_exame" class="col-sm-2 control-label padding-label">Sigla</label>
                        <div class="col-sm-4 padding-field">
                            <input type="text" class="form-control proximo_campo" id="sg_exame" maxlength="25" placeholder="Abreviação...">
                        </div>
                        <label for="un_exame" class="col-sm-1 control-label padding-label">Unidade</label>
                        <div class="col-sm-1 padding-field">
                            <input type="text" class="form-control proximo_campo" id="un_exame" maxlength="25" placeholder="mg/dL">
                        </div>
                    </div>
                    <div class="form-group" style="margin: 2px;">
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $('#qtde-registros-exame').val(<?php echo $qtde;?>);
                $('#qtde-registros-exame').select2();
            ...
            function configurar_tabela(id) {
                if (typeof($(id)) !== "undefined") {
                    var qt_registros = parseInt('0' + $('#qtde-registros-exame').val());
                    $(id).DataTable({
                        "paging": true,
...
//                        ],
            ...
            function abrir_cadastro(handler, id) {
                ...
                var registro = id.replace("reg-exame_", "");
                
                carregar_registro_tabela_exame(registro, function(data){
                    $('#operacao').val("editar");
                    
                    $('#id_exame').val(data.registro[0].id);
                    $('#cd_exame').val(zero_esquerda(data.registro[0].codigo, 2));
                    $('#nm_exame').val(data.registro[0].nome);
                    $('#sg_exame').val(data.registro[0].sigla);
                    $('#un_exame').val(data.registro[0].unidade);
            ...
            function fechar_filtro(pesquisar) {
                ...
                $('#box-filtro').hide();
                if (pesquisar === true) pesquisar_tabela_exames();
            } 
            ...
            function salvar_cadastro() {
                ...
                if ($('#nm_exame').val() === "") requedido += "<li>Nome</li>";
                if ($('#sg_exame').val() === "") requedido += "<li>Abreviação ou Sigla</li>";

                if (requedido !== "") {
                    show_campos_requeridos("Alerta", "Cadastro de exames", requedido);
                } else {    
                    salvar_registro_tabela_exame(registro, function(data){
                        ...
                        set_status_fa('#status_exame_' + referencia, $('#sn_ativo').is(":checked"));
            ...
            function excluir_registro(id, elemento) {
                ...
                var acesso  = "0100";
                get_allow_user(usuario, rotina, acesso, function(){
                    var registro  = id.replace("excluir_exame_", "");
                    ...
                    excluir_tabela_exame(registro, descricao, function(){
