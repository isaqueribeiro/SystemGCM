...
<?php
    ...
    $qtde = 10;
    $file = "../logs/cookies/tabela_preco_" . sha1($user->getCodigo()) . ".json";
    if (file_exists($file)) {
...
<html>
  <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content-header">
          <h1>
            Tabela de Preços
            <small>Relação de valores a serem cobrados nos atendimentos</small>
          ...
          <ol class="breadcrumb">
              ...
              <li class="active" id="page-click" onclick="preventDefault()">Tabela de Preços</li>
          </ol>
        </section>
            ...
            <div class="box-body form-horizontal">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <select class="form-control select2"  id="qtde-registros-tab" style="width: 70px;">
          ...
          <div class="box box-info" id="box-pesquisa">
              <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                      ...
                      <button type="button" class="btn btn-primary" title="Atualizar" onclick="pesquisar_tabela_precos()" id="btn-atualizar-pesquisa"><i class="fa fa-refresh"></i></button>
              ...
              <div class="box-body form-horizontal" id="box-formulario">
                <div class="col-md-10">
                    <div class="form-group" style="margin: 2px;">
                        <label for="cd_tabela" class="col-sm-2 control-label padding-label">Código</label>
                        <div class="col-sm-2 padding-field">
                            <input type="text" class="form-control proximo_campo" id="cd_tabela" maxlength="5" placeholder="000" readonly>
                        </div>
                    </div>
                    <input type="hidden" id="nm_tabela">
                    <div class="form-group" style="margin: 2px;">
                        <label for="cd_convenio" class="col-sm-2 control-label padding-label">Categoria</label>
                        <div class="col-sm-5 padding-field">
                          <select class="form-control select2 proximo_campo" id="cd_convenio" style="width: 100%;">
                    ...
                    <div class="form-group" style="margin: 2px;">
                        <label for="tp_atendimento" class="col-sm-2 control-label padding-label">Tipo de atendimento</label>
                        <div class="col-sm-5 padding-field">
                    ...
                    <div class="form-group" style="margin: 2px;">
                        <label for="cd_especialidade" class="col-sm-2 control-label padding-label">Especialidade</label>
                        <div class="col-sm-5 padding-field">
                          <select class="form-control select2 proximo_campo" id="cd_especialidade" style="width: 100%;">
                    ...
                    <div class="form-group" style="margin: 2px;">
                        <label for="vl_servico" class="col-sm-2 control-label padding-label">Valor (R$)</label>
                        <div class="col-sm-2 padding-field">
...
//                } catch (er) {
//                }
                $('#qtde-registros-tab').val(<?php echo $qtde;?>);
                $('#qtde-registros-tab').select2();
            ...
            function configurar_tabela(id) {
                if (typeof($(id)) !== "undefined") {
                    var qt_registros = parseInt('0' + $('#qtde-registros-tab').val());
                    $(id).DataTable({
                        "paging": true,
...
//                        ],
            ...
            function abrir_cadastro(handler, id) {
                ...
                var registro = id.replace("tabela_preco_", "");
                
                carregar_registro_tabela_preco(registro, function(data){
                    $('#operacao').val("editar");
                    
                    $('#cd_tabela').val(zero_esquerda(data.registro[0].codigo, 3));
                    $('#nm_tabela').val(data.registro[0].nome);
            ...
            function fechar_filtro(pesquisar) {
                ...
                $('#box-filtro').hide();
                if (pesquisar === true) pesquisar_tabela_precos();
            } 
            ...
            function salvar_cadastro() {
                var registro  = $('#cd_tabela').val();
                var requedido = "";

                if ($('#cd_convenio').val() === "0") requedido += "<li>Categoria</li>";
                if ($('#tp_atendimento').val() === "0") requedido += "<li>Tipo de Atendimento</li>";
                if ($('#cd_especialidade').val() === "0") requedido += "<li>Especialidade</li>";
                if ($('#vl_servico').val() === "") requedido += "<li>Valor do Serviço (R$)</li>";

                if (requedido !== "") {
                    show_campos_requeridos("Alerta", "Tabela de Preços", requedido);
                } else {    
                    salvar_registro_tabela_preco(registro, function(){
                        var linha = "#tr-linha_" + parseFloat($('#cd_tabela').val());
                        $('#id_linha').val(linha);

                        // Atualizar status do registro na tabela
                        var referencia = parseInt("0" + $('#cd_tabela').val());
                        set_status_fa('#status_tabela_preco_' + referencia, $('#sn_ativo').is(":checked"));
            ...
            function excluir_registro(id, elemento) {
                ...
                var acesso  = "0100";
                get_allow_user(usuario, rotina, acesso, function(){
                    var registro  = id.replace("excluir_tabela_preco_", "");
                    ...
                    excluir_tabela_preco(registro, descricao, function(){
